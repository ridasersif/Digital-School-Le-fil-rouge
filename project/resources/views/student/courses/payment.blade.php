...
@section('contents')
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="payment-summary">
                    ...
                    <div class="text-center">
                        <p class="mb-1"><strong>Garantie de satisfaction de 30 jours</strong></p>
    ...
    <script>
        ...
        // Load course data and payment summary
        ...
        function loadCourseData() {
            fetch("{{ route('payment.get.courses') }}")
                ...
                .catch(error => {
                    ...
                    document.getElementById('cours-list').innerHTML = 
                        '<div class="alert alert-danger">Erreur lors du chargement des cours. Veuillez réessayer.</div>';
                    document.getElementById('payment-summary').innerHTML = 
                        '<div class="alert alert-danger">Erreur lors du chargement du résumé. Veuillez réessayer.</div>';
                });
        }
        ...
        function displayCourses(courses) {
            ...
            if (courses.length === 0) {
                coursesContainer.innerHTML = '<div class="alert alert-info">Votre panier est vide</div>';
                return;
            }
                ...
                coursesHTML += `
                    <div class="d-flex mb-3 pb-3 border-bottom">
                        <div class="flex-shrink-0" style="width: 80px">
                            <img src="${course.image}" alt="${course.titre}" class="img-fluid rounded">
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h5 class="course-title">${course.titre}</h5>
                            <div class="course-meta">
                                <span>Par ${course.formateur}</span>
                                <span class="ms-2">${course.duree || 'Durée inconnue'}</span>
                                <span class="ms-2">${course.niveau || 'Tous niveaux'}</span>
                            </div>
                        </div>
                        <div class="flex-shrink-0 text-end" style="min-width: 80px">
                            <h6 class="mb-0">${course.price.toFixed(2)} MAD</h6>
                            ${course.old_price ? `<small class="text-muted text-decoration-line-through">${course.old_price.toFixed(2)} MAD</small>` : ''}
                        </div>
                    </div>
                `;
            });
        ...
        function displaySummary(summary) {
            ...
            summaryContainer.innerHTML = `
                <div class="d-flex justify-content-between mb-2">
                    ...
                    <span class="text-muted text-decoration-line-through">${summary.original_price.toFixed(2)} MAD</span>
                </div>
                
                <div class="d-flex justify-content-between mb-2">
                    <span>Prix réduit:</span>
                    <span>${summary.reduced_price.toFixed(2)} MAD</span>
                </div>
                
                <div class="d-flex justify-content-between mb-2">
                    <span>Vous économisez:</span>
                    <span class="text-success">${summary.saving.toFixed(2)} MAD (${summary.saving_percent}%)</span>
                </div>
                ...
                <div class="d-flex justify-content-between mb-0">
                    ...
                    <span class="h5 fw-bold">${summary.total.toFixed(2)} MAD</span>
                </div>
            `;
        }
