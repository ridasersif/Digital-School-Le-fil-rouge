...
class StoreContentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        switch ($this->type) {
            case 'video':
                $rules['chemin_video'] = 'required|file|mimes:mp4,mov,avi,wmv|max:51200'; 
                $rules['duree_video'] = 'nullable|integer|min:1';
                break;
            case 'pdf':
                $rules['chemin_pdf'] = 'required|file|mimes:pdf|max:20480'; 
    ...
    public function messages(): array
    {
        return [
            ...
            'chemin_video.required' => 'La vidéo est obligatoire.',
            ...
            'chemin_pdf.required' => 'Le fichier PDF est obligatoire.',
